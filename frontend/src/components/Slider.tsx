function Slider() {
  return (
    <div className="container mx-auto mr-4 pb-4">
      <div className="flex flex-wrap gap-4">
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-[#7879fe] dark:border-gray-700">
          <svg
            className="w-7 h-7 text-gray-500 dark:text-black mb-3"
            aria-hidden="true"
          ...
          <p className="mb-3 font-normal text-gray-500 dark:text-black">
        ...
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-[#7879fe] dark:border-gray-700">
          ...
          <p className="mb-3 font-normal text-gray-500 dark:text-black">
            You can write in your journal when not at your computer with our iOS
            and Android apps.
          </p>
        ...
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-[#7879fe] dark:border-gray-700">
          ...
          <p className="mb-3 font-normal text-gray-500 dark:text-black">
            Never worry about losing your work — Penzu saves as you type at your
            computer or on the go.
          </p>
